...
// CONFIGURACIÓN
var FICH_DATA = __dirname + '/data/programa_cat.csv';
var DELIMITER = '\t';
...
function(err, medidas_csv) {
	...
	fs.writeFileSync(__dirname+'/web/programa_cat.html', pagina);
	fs.writeFileSync(__dirname+'/web/programa_cat.min.html', minify(pagina, { 
